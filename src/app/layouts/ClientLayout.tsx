...
export function ClientLayout() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 max-w-md mx-auto">
      ...
      <nav className="fixed bottom-3 left-3 right-3 max-w-md mx-auto bg-white/55 dark:bg-gray-800/45 glass-surface border border-white/60 dark:border-white/10 px-4 py-2.5 rounded-3xl shadow-[0_8px_32px_rgba(201,163,232,0.25),inset_0_1px_0_rgba(255,255,255,0.6)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.07)]">
